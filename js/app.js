...
class UI {
   ...
   imprimirCitas() { 
       ...
       //Leer el contenido de la base de taos
...
function nuevaCita(e) {
    ...
    if (editando) {
        ...
        //Transaction.oncomplete es como un if, es decir que si se complete ejecuta el siguiente codigo
        ...
        // Insertar en la base de datos de indexDB
        const transaction = DB.transaction(['citas'], 'readwrite');
